...
export class ListFullError extends ListsPluginError {
    constructor(maxItems: number) {
        super(ListErrorCode.LIST_FULL, `List is full (max ${maxItems} items)`, undefined, {
            maxItems,
        });
...
export class ItemAlreadyExistsError extends ListsPluginError {
    constructor(entityId: string | number) {
        super(ListErrorCode.ITEM_ALREADY_EXISTS, 'Item already exists in list', 'entityId', {
            entityId,
        });
...
export class CannotDeleteDefaultError extends ListsPluginError {
    constructor() {
        super(ListErrorCode.CANNOT_DELETE_DEFAULT, 'Cannot delete default favorites list');
...
export class EntityValidationFailedError extends ListsPluginError {
    constructor(entityId: string | number) {
        super(ListErrorCode.ENTITY_VALIDATION_FAILED, 'Entity validation failed', 'entityId', {
            entityId,
        });
